\documentclass[a4paper]{article}
    ...
    \begin{document}
        ...
        \cornell[Key Concepts]{What are this chapter's key concepts?}{\begin{itemize}
            \item \textbf{9.1.I.C} - Debates continued over free-trade, scope of govt. social safety net, U.S. financial reform
            \item \textbf{9.2.I.A} - $\uparrow$ digital communications $\to$ $\uparrow$ econ. opportunity on international stage
            \item \textbf{9.2.I.B} - Tech. innovations transformed daily life, changing social behavior
            \item \textbf{9.2.I.D} - Wages stagnated for working/middle class
            \item \textbf{9.2.II.B} - $\uparrow$ migration from Latin America/Asia affecting U.S. culture, serving as key labor source
            \item \textbf{9.2.II.C} - Political/cultural debates emerged over immigration, diversity, gender roles, family structures
            \item \textbf{9.3.I.C} - End of Cold War $\to$ new diplomacy, U.S. mil. interventions w/ continued debate over use of U.S. power
            \item \textbf{9.3.II.A} - Attacks on World Trade Center + Pentagon $\to$ U.S. launched international war on terrorism, conflicts in Afghanistan/Iraq
            \item \textbf{9.3.II.B} - War on terrorism sought to improve U.S. security; raised important human rights questions
            \item \textbf{9.3.II.C} - Middle East conflicts, climate change concerns $\to$ debates over U.S. use of fossil fuels
            \item \textbf{9.3.II.D} - U.S. remained world superpower in 21st century despite econ./foreign challenges
        \end{itemize}}
