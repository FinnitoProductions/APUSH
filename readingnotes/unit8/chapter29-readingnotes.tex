\documentclass[a4paper]{article}
    ...
    \begin{document}
        ...
        \cornell[The Traumas of 1968]{What were the most disastrous events of 1968?}{\textbf{1968 started off with the Tet offensive in the Vietnam War, where communists attacked South Vietnam; although they lost militarily, the brutality led to even more reduced home front support for the war. Politically, Democrats immediately sought alternatives to Johnson, who quickly pulled out of the race; Eugene McCarthy was the most staunchly anti-war, but Robert Kennedy's sympathy with minorities made him another strong candidate. However, Hubert Humphrey, supported by Johnson, ultimately garnered the most support and won the Democratic nomination despite the extreme vocalizations of antiwar supporters. MLK's and Robert Kennedy's assassinations led to nationwide grief; regardless, the presidential race continued. George Wallace, the segregationist independent candidate from Alabama, garnered significant conservative support; however, Richard Nixon ultimately won the election due to his stabilizing goals for peace in Vietnam and the preservation of American society.}}
        \cornell{How did the Tet offensive continue the Vietnam war?}{\begin{itemize}
            \item Jan. 1968: first day of Vietnamese New Year saw communist forces launch major attack on South Vietnam strongholds; occupied and massacred supporters of South regime 
            \begin{itemize}
                \item Event described on television w/ brutality made clear $\to$ popular support destroyed 
                \item Video of Viet Cong soldier being shot in head by South Vietnamese officer further eliminated support 
                \item Tet offensive depleted NLF forces, forcing North Vietnamese to come in; represented major military success but political defeat due to $\downarrow$ war support
            \end{itemize}
            \item War opposition grew w/ newspapers/magazines/television pushing end of conflict; Johnson's popularity dropped to 35\% 
        \end{itemize}
        \textbf{The Tet offensive saw communist forces launch a major attack on the South; although the U.S. successfully depleted the forces, particularly damaging the NLF, Tet was ultimately a failure due to the obvious brutality leading to extremely reduced war support.}}
        \cornell{How did opposition to the war manifest itself on the political side?}{\begin{itemize}
            \item Democrats sought to find alternative to Johnson in 1968 primaries but declined by Robert Kennedy $\to$ found Eugene McCarthy w/ powerful early showing
            \item Robert Kennedy joined soon after w/ support of Afr. Americans, poor, workers
            \item Johnson's performance very limited due to extreme hatred $\to$ announced, on television, halt in bombing of North Vietnam as well as withdrawal from presidency
            \item Robert Kennedy seemed to be winning until entrance of Hubert Humphrey, VP supported by Johnson; Humphrey supported by party leaders, delegations $\to$ became front-runner 
        \end{itemize}
        \textbf{Johnson had no chance in the 1968 primaries: public animosity due to the war was far too high. The first alternative to Johnson was Eugene McCarthy, who was then beat out by Robert Kennedy, who was then beat out by Hubert Humphrey.}}
        \cornell{How did the assassinations of MLK and Robert Kennedy shake the nation?}{\begin{itemize}
            \item April 4th, 1968 saw assassination of MLK in Memphis, TN, by \textbf{James Earl Ray}, w/ motive unknown - seemingly hired by unknown employers
            \begin{itemize}
                \item King's death $\to$ grief matching that to John Kennedy's death
                \item Stimulated major city riots w/ many dead 
            \end{itemize}
            \item Robert Kennedy continued to campaign, but killed by Palestinian \textbf{Sirhan Sirhan} angered by Kennedy's pro-Israeli comments
            \begin{itemize}
                \item By death, viewed as extremely popular figure (despite early reputation as cold/ruthless) particularly among U.S. "underclass" and minorities
                \item Believed strongly in what was later termed "Kennedy legacy": goal to use government to assist the powerless
                \item Presidential campaign continued, w/ Hubert Humphrey easily poised to win
                \begin{itemize}
                    \item Antiwar activists continued demonstrations in support of McCarthy
                    \item Third night, as balloting began for Humphrey, violent, bloody riots emerged in Chicago w/ police stopping
                    \item Humphrey had won nomination but seemed increasingly useless
                \end{itemize}
            \end{itemize}
        \end{itemize}
        \textbf{Martin Luther King's assassination for unknown reasons led to national grief and major riots. Robert Kennedy was killed only a few months later by a Palestinian angered by his pro-Israeli stance; Kennedy was known for his constant push to support the "underclass" of America. Regardless, the campaign continued, with Humphrey poised to win; antiwar activists, recognizing the increasingly dire straits, campaigned fervently with violent antiwar demonstrations, but Humphrey ultimately won the nomination.}}
        \cornell{How did conservatives respond to the Democratic tension?}{\begin{itemize}
            \item AL governor George Wallace, known for segregationist beliefs, became third-party candidate w/ platform based on large number of conservative grievances
            \begin{itemize}
                \item Large number of complaints against race; others against forced busing of students, excessive govt. regulation, authority allowance of antiwar demonstrations/race riots
            \end{itemize}
            \item Richard Nixon sought to mobilize "silent majority," speaking for "Middle America"
            \begin{itemize}
                \item Rather than advocating for poor, racial justice, offered goal for ultimate national stability, reaching place of honorable peace in Vietnam
                \item Great lead in polls due to Democratic disaster
                \item Wallace seemed to be taking away from Repub. vote, Humphrey coordinated last-minute surge to make vote \underline{very tight}
                \item Nixon won election narrowly (Wallace dropped off in final weeks); not a mandate but reflected U.S. goal to find stability 
            \end{itemize}
        \end{itemize}
        \textbf{Alabama governor George Wallace saw extreme success as a third-party candidate, with most of his arguments based on race appealing directly to conservatives. Richard Nixon, however, stressed a platform of stability and peace, hoping to mobilize the silent majority; although Wallace took most of his votes from the Republican side and Humphrey saw a last-minute pre-election resurgence, Nixon won the election narrowly.}}
    \end{document}