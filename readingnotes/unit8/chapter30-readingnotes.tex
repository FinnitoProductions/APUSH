\documentclass[a4paper]{article}
    ...
    \begin{document}
        ...
        \cornell[The Watergate Crisis]{How did Watergate mark the end of Nixon's presidency?}{\textbf{Nixon's resignation as a result of the Watergate crisis was stimulated not by his direct involvement in such illegal activities but instead by his attempt to cover up these activities. His refusal to release potentially incriminating White House tapes further aggravated suspicions; after the Supreme Court forced him to release his tapes, which revealed his attempts to cover up the Watergate break-in, impeachment and conviction seemed nearly inevitable. Nixon made the decision to resign from the presidency, which, though becoming a source of joy to many American people, represented the increased distrust of American leadership.}}
        \cornell{What factors led up to Watergate?}{\begin{itemize}
            \item Public expectations of presidency had shifted after WWII but authority had been constrained $\to$ many presidents forced to find illegal methods of exercising power 
            \item Democratic Congress paired w/ unresponsive bureaucracy $\to$ Nixon concentrated power in White House with rigid staff structure, eventual abuses of power
            \item Mid-1972: police arrested men breaking into Dem. national committee at Watergate building in DC; two others later charged
            \begin{itemize}
                \item Reporters discovered that former employees for Nixon's reelection were involved; paid by White House staff to execute secret break-in
                \item Watergate robbers went on trial: \textbf{James W. McCord} revealed extreme illegality in Nixon's campaign; eventually tied back to Nixon himself
            \end{itemize}
            \item Two major scandals: one was routine law-breaking by Nixon like w/ Watergate payments; other was Nixon's attempt to cover up scandals 
            \begin{itemize}
                \item No evidence that Nixon was involved in Watergate; evidence revealed he had attempted to obstruct investigations
                \item Focus on question as to how much Nixon knew about scandals and when he found out
            \end{itemize}
            \item Key members departed from administration; Nixon insisted he was innocent until White House taping system which would potentially reveal Nixon's knowledge
            \begin{itemize}
                \item Nixon-appointed prosecutor, \textbf{Archibald Cox}, took to court in attempt to force Nixon to reveal tapes $\to$ Nixon fired Cox $\to$ Nixon's Attorney General and deputy both resigned
                \item New federal prosecutor appointed; questions of impeachment began to emerge
            \end{itemize}
        \end{itemize}
        \textbf{Nixon's Watergate scandal began after several men sponsored by Nixon's reelection committee were caught breaking into Democratic offices. Although little evidence emerged revealing that Nixon had been involved in the Watergate scandal, significant evidence revealed his attempt to obstruct the emerging scandals: after he refused to publish his White House tapes and fired his special prosecutor, the question of impeachment emerged.}}
        \cornell{How did Richard Nixon ultimately fall?}{\begin{itemize}
            \item VP Spiro Agnew faced another scandal revealing he had taken bribes, evaded income tax $\to$ resigned from govt.; replaced by \textbf{Gerald Ford}
            \begin{itemize}
                \item Ford well-liked $\to$ Nixon's opponents even more comfortable to remove Nixon from White House
            \end{itemize}
            \item Apr. 1974: \textit{United States v. Richard M. Nixon} forced Nixon to release tapes (he had only released selected, edited transcripts); House Judiciary Committee voted three articles of impeachment 
            \begin{itemize}
                \item Charged for obstruction of justice in Watergate, misuse of fed. offices to violate citizens, defiance of Congress in refusal to publish tapes 
                \item Relinquished tapes revealed that after Watergate, had ordered FBI to cease investigation $\to$ impeachment essentially inevitable 
                \item Aug. 8, 1974: announced resignation, first president to do so
                \item Reflected dramatic transformation of American public life
            \end{itemize}
        \end{itemize}
        \textbf{After Nixon's Vice President, Agnew, resigned and was replaced by Ford, Nixon's opponents were even more comfortable removing him from office. Nixon was soon forced by the Supreme Court to release his tapes, which immediately exposed his attempts to cover up the Watergate scandal; impeachment proceedings began. Nixon announced his resignation, marking a transformation in the American public life.}}
       \end{document}