\documentclass[a4paper]{article}
    ...
    \newcommand{\chapternumber}{11}
    \newcommand{\chaptertitle}{Cotton, Slavery, and the Old South}
    ...
    \cornell[The Culture of Slavery]{How did slaves develop a unique culture?}{\textbf{Slaves generally spoke a common language blending English and African known as "pidgin," unqiue music to clear their minds of work and also rebel against their masters, and religious ideals incorporating distinctly African elements of emotional preaching and polytheism into Christianity. Slaves, due to the slave trade often relocating them, formed unique kinship networks and married with the same passion as did whites; many regarded their masters with notable ambivalence, unsure of whether to appreciate their supply of food, clothing, and shelter, or to despite their harsh, often tyrannical treatment.}}
    \cornell{How did most slaves approach language?}{\textbf{Some areas, made up of slaves descending from similar regions in Africa, spoke predominantly African languages; most however, spoke "pidgin," a simple language created by first-generation slaves unable to communicate blending some African words into mostly English.}}
    \cornell{How did slaves develop a unique musical culture?}{\textbf{Music relied on vocal work, with workers singing to pass the time. Othesrs created discreet songs to subtly rebel against authority and to convey a spiritual message.}}
    \cornell{How did slaves transform Christianity to reflect their conditions and native traditions?}{\begin{itemize}
        \item Masters sought no unique slave religion, converting all to Christianity (aligning w/ their owners' beliefs, mostly Protestant) and banning independent black churches
        \item Unique form of Christianity developed, at times incorporating voodoo and polytheism but sometimes simply allowing most pious to become preachers
        \begin{itemize}
            \item More emotional than white Christianity (infl. by Afr. customs), describing powerful conversions and stressing the beauty of freedom 
            \item Masters interpreted goal to reach "Promised Land" as life after death, but many applied to present
            \item Open resistance usually relied on black Christian images 
        \end{itemize}
        \item Southern towns often had dedicated churches w/ free blacks alongside slaves; countryside saw most slaves accompanying masters (sometimes on plantation itself) w/ segregated seating
     \end{itemize}
     \textbf{Although most masters sought that all slaves strictly followed Christianity, most developed a unique form often with voodoo and polytheism but at times mere emotion expressing the power of freedom, which inspired many major revolts. Although cities had dedicated black churches for free blacks and slaves, rural slaves generally attended segregated churches with their masters.}}
     \cornell{What were the critical family structures for slaves?}{\begin{itemize}
         \item Families often struggled due to lack of legal marriage, but generally fit into modern American family ideal
         \item Marriage ideals often disparate from surrounding whites
         \begin{itemize}
            \item Black women often bore children as early as 14/15 due to no concept of premarital pregnancy
            \item Often lived together before marrying
            \item Formal vows; often married slaves on neighboring plantations (masters often authorized visits but occasionally secret -> still held strong bond)
            \item Marriage often collapsed due to slave trade breaking up families (most slaves lost majority of relatives)
         \end{itemize}
         \item Kinship networks evolved to allow slaves having lost family members, w/ greater focus on distant family
         \begin{itemize}
             \item Sometimes "adopted" by new family when one slave transferred to entirely new region
             \item Bonds often too strong to separate: slaves often escaped to find departed relative
         \end{itemize}
         \item Whites also intruded w/ sexual advances $\to$ kids not accepted in white society
         \item Slaves formed \textit{very complex} relations w/ masters; never completely hostile
         \begin{itemize}
             \item Masters did provide food, clothing, shelter, protection from outside world
             \item Often paternal relationship (at times harsh, other times kind) which further emphasized white control, mitigating the risk of slave revolts
         \end{itemize}
     \end{itemize}
     \textbf{Although slaves were unable to marry legally, they generally held formal ceremonies and formed bonds equally strong to those held by most white families despite geographic separation. The constant transfer of slaves between plantations meant that most relied on kinship networks, or closer bonds with their distant relatives; slaves transferred alone formed new bonds with an adopted family. Slaves struggled to entirely despise their masters despite frequent harsh conditions: they did receive food, clothing, and shelter, forming a father-son relationship.}}
    \end{document}