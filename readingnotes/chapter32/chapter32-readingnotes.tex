...
\cornell{What changes occurred in the American population?}{
    \begin{itemize}
        \item As birth rates decreased and life spans increased, population marked by increased agedness, specifically in "baby boomers"
        \begin{itemize}
...
\cornell{How did the perception of America for African Americans compare to that for white Americans in the post-civil rights era?}{
    \begin{itemize}
        ...
        \end{itemize}
        \item Black middle-class (over half of African American population) experienced most remarkable progress
        \begin{itemize}
        ...
        \end{itemize}
        \item Many other groups, most prominently impoverished blacks ("underclass"), still left with few benefits from social prosperity
        \begin{itemize}
