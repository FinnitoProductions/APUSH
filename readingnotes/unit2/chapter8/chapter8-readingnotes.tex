\documentclass[a4paper]{article}
    ...
    \cornell{What was the Missouri Compromise?}{\begin{itemize}
        ...
        \end{itemize}
        \item Jesse B. Thomas proposed amendment to prohibit slavery north of southern border ofMO in Louisiana Purchase land; passed and hailed by nationalists in North and South for ability to keep Union together
    \end{itemize}
    ...
    \cornell{How did John Marshall revolutionize the American judiciary system?}{\begin{itemize}
        \item Increased power of federal government at expense of states, advanced interests of propertied classes
        \item Promoted commerce by strictly abiding by contracts
        \begin{itemize}
            \item \textit{ex}: \textit{Fletcher v. Peck} saw notorious land frauds in Georgia, Marshall held that land grants were valid, unable to be repealed regardless of corruption
        \end{itemize}
        \item \textit{Dartmouth College v. Woodward} saw expanded meaning of contract clause w/ Republicans having gained control of NH government, attempting to revise Dartmouth's charter
        \begin{itemize}
    ...
    \cornell[The Revival of Opposition]{How did partisan tensions return in the United States?}{\textbf{Partisan tensions returned when the "corrupt bargain" claimed by Jacksonians after Clay and Adams made an alleged deal. Adams' presidency was somewhat unsuccessful due to the great opposition; this opposition was channeled into a system with Democratic Republicans under Andrew Jackson and National Republicans under John Quincy Adams. Ultimately, the Democratic Republicans won the election of 1828.}}
    ...
    \cornell{What was the "corrupt bargain"?}{\begin{itemize}
        ...
        \item In 1824, Republican caucus nominated William H. Crawford; other canditates nominated by state legislatures, mass meetings -> less organized, more opportunity
        \begin{itemize}
