\documentclass[a4paper]{article}
    ...
    \newcommand{\chaptertitle}{The Collision of Cultures}
    ...
    \cornell[Key Concepts]{What are this chapter's key concepts?}{\begin{itemize}
        \item \textbf{1.1.I.A} - Spread of maize cultivation from modern Mexico northward to U.S. Southwest allowed for signif. econ./social development and irrigation
        \item \textbf{1.1.I.B} - Societies developed mobile lifestyles in response to aridity of Great Basin/Great Plains
        \item \textbf{1.1.I.C} - Northeast, MS River Valley, Atlantic seaboard saw societies create agri./hunter-gatherer economies allowing for villages
        \item \textbf{1.1.I.D} - Northwest, modern CA societies subsisted primarily through hunting and gathering
        \item \textbf{1.2.I.A} - Euro. efforts to conquer New World motivated by desire for new sources of wealth, econ./mil. conquest, desire to spread Christianity
        \item \textbf{1.2.I.B} - Columbian Exchange brought crops from Americas to Europe, allowing for pop. growth, new wealth sources leading to Euro. shift from feudalism to capitalism
        \item \textbf{1.2.I.C} - Maritime improvements, organized methods of conducting trade (\textit{ex}: joint stock companies) allowed for economic changes in Europe/Americas
        \item \textbf{1.2.II.A} - Spanish exploration, conquest of Americas accompanied/furthered by widespread epidemics destroying native population as well as introduction of new crops
        \item \textbf{1.2.II.B} - \textit{Encomienda} system allowed Spanish economies to use native labor for plantation agri., metallurgy
        \item \textbf{1.2.II.C} - European traders worked w/ West African groups to get slave labor; Spanish imported Africans for plantation agri./mining
        \item \textbf{1.2.II.D} - Spanish formed rigid racial hierarchy incorporating Europeans, Africans, natives
        \item \textbf{1.2.III.C} - Contact w/ natives and Africans created Euro. debate over how to treat non-Europeans; formed cultural/racial justification for subjugation
        \item \textbf{2.1.I.A} - Spanish goal to extract wealth $\to$ converted natives to Christianity as well as enslaved/free Africans for labor use
        \item \textbf{2.1.III.F} - Native resistance to Spanish colonialism (\textit{ex}: Pueblo Revolt) $\to$ Spanish incorporated some elements of native culture
    \end{itemize}}
    ...
    \cornell{What characterized the shift from bypass to conquering in North America?}{
        ...
        \cornell[The Arrival of the English]{What characterized English expansion in the New World?}{\textbf{Although the English made contact with the New World shortly after Spain did, their internal society was not prepared for long-term settling of new lands. However, their eventual societal growth and multiple wins against Spain in battle encouraged them to begin colonizing, starting out with small settlements at Roanoke.}}
        ...
        \cornell{What sparked the first English attempts at colonization?}{\begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Significant victory after Armada completely defeated by British
            \end{itemize}
            \item Colonization pioneers: Humphrey Gilbert, Walter Raleigh, friends of Elizabeth I, Ireland veterans
            \begin{itemize}
                \item Gilbert led expedition to Newfoundland, claimed for queen
                \item Failed to expand after ship sank by storm, leaving him lost at sea
            \end{itemize}
        \end{itemize}
        \textbf{Britain's multiple wins against Spain (most notably with the large Spanish Armada) encouraged them to begin settlement, which was initially led by Gilbert and Raleigh.}
        }
        \cornell{What was Roanoke?}{
            \begin{itemize}
                \item Undeterred by failures of Gilbert, Raleigh secured grant from queen to explore and attempt colonization
                \begin{itemize}
                    \item Returned with two natives, raving about island of Roanoke 
                    \item Named region after Elizabeth the "Virgin Queen": "Virginia"
                    \item Unable to receive additional grant: turned to private investors
                \end{itemize}
                \item Raleigh recruited cousin \textbf{Grenville} to bring settlers to island
                \begin{itemize}
                    \item Grenville deposited settlers, remained there for enough time to antagonize native village
                    \item Sir Francis Drake later arrived with overdue goods; all colonists departed
                \end{itemize}
                \item Raleigh attempted again with larger group, some pregnant women
                \begin{itemize}
                    \item First child born to daughter of expedition's commander: John White
                    \item White returned to England after many weeks to seek new supplies/settlers
                    \begin{itemize}
                        \item Held back by hostilities w/ Spain
                        \item Returned three years later to find colony deserted w/ "Croatoan" inscription
                        \item Fate of settlers still unknown: perhaps slaughtered by natives or assimilated into native society
                    \end{itemize}
                \end{itemize}
                \item After "Lost Colony" disaster, Raleigh's time as an explorer ended
                \begin{itemize}
