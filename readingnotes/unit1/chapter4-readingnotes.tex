\documentclass[a4paper]{article}
    ...
    \cornell[Key Concepts]{What are this chapter's key concepts?}{\begin{itemize}
        \item \textbf{2.2.I.C} - British government increasingly attempted to incorporate North American colonies into coherent, imperial structure with mercantilist aims; failed due to conflict w/ colonists and natives 
        \item \textbf{2.2.I.D} - Colonists drew on local self-government to resist imperial control: liberty began to grow as a major concept
        \item \textbf{3.1.I.A} - Colonial rivalry between Britain and France intensified, threatening French-native trade networks and nativr autonomy
        \item \textbf{3.1.I.B} - Britain defeated the French, expanding territorial holdings
        \item \textbf{3.1.I.C} - Imperial officials attempted to prevent westward expansion - natives hoped to continue trading with Europeans while resisting colonial expansion 
        \item \textbf{3.1.II.A} - 18th century imperial struggles, GB efforts to collect taxes and assert w/o colonial representation $\to$ colonists began to unite
        \item \textbf{3.1.II.B} - Colonial leaders based calls for resistance on arguments about rights of British subjects
        \item \textbf{3.1.II.C} - American independence effort pushed by powerful leaders like Franklin
    \end{itemize}}
